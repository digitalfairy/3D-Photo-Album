...
const MOCK_USER_ID = "user_dev_bypass_01";
const API_UPLOAD_URL = "http://localhost:3001/api/images/upload"; 
...
useEffect(() => {
    ...
    fetchUserPages(MOCK_USER_ID); 
    } else if (authLoaded && !isSignedIn) {
    fetchUserPages();
    }
}, [authLoaded, isSignedIn, fetchUserPages]); 
...
if (!response.ok) {
    ...
    await fetchUserPages(MOCK_USER_ID); 
